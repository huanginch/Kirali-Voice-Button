...
.vo-btn-bg-light {
  background: linear-gradient(to right, #d13f67 var(--start-percent), #e16f89 var(--progress));
}

.vo-btn-bg-dark {
  background: linear-gradient(to right, #ac3c5c var(--start-percent), #be5c86 var(--progress));
}
